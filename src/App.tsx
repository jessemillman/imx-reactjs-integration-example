...
const App = () => {
  ...
  async function linkSetup(): Promise<void> {
    ...
    const balnaceresponce: any = await balanceApi.getBalance({
      owner: res.address,
      address: "eth",
    });
    balnaceresponce["data"]["balance"] = ethers.utils.formatUnits(
      balnaceresponce["data"]["balance"],
      18
    );
